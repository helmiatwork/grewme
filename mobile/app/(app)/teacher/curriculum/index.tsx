...
export default function TeacherSubjectsListScreen() {
  ...
  if (subjectsError) {
    return (
      <ErrorState
        message={subjectsError.message || 'Failed to load curriculum'}
        onRetry={() => {
          if (schoolId) {
            refetchSubjects();
          }
    ...
    return (
      <View style={styles.emptyContainer} testID="curriculum-no-school">
        ...
        <Text style={styles.emptyHint}>
          Please select a school from the dashboard first.
        </Text>
      </View>
    );
  }
  ...
  if (subjects.length === 0) {
    return (
      <View style={styles.emptyContainer} testID="curriculum-empty">
        ...
        <Text style={styles.emptyHint}>
          Subjects will appear once they are added to this school.
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.container} testID="subjects-list-screen">
      <View style={styles.headerRow}>
        ...
        <Pressable
          ...
          onPress={() => router.push('/(app)/teacher/curriculum/yearly')}
        >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            ...
            onPress={() => router.push(`/(app)/teacher/curriculum/${item.id}`)}
          >
