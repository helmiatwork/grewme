<script lang="ts">
  ...
  // Event dates for current view month (Set of day numbers)
  ...
  // Filtered events based on selected day
...
<div class="max-w-3xl mx-auto space-y-6">
  <h1 class="text-2xl font-bold text-text">Calendar</h1>

  <!-- ── Create Event Form ──────────────────────────────────────────────── -->
  <Card>
    {#snippet header()}
      <h2 class="text-base font-semibold text-text">Add Event</h2>
    {/snippet}
    {#snippet children()}
      {#if formError}
        <div class="mb-4">
      ...
      <form onsubmit={handleCreate} class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <!-- Date -->
        <div>
          <label for="eventDate" class="block text-sm font-medium text-text mb-1">Date</label>
          <input
            id="eventDate"
            type="date"
            bind:value={formDate}
        ...
        <!-- Start Time -->
        <div>
          <label for="startTime" class="block text-sm font-medium text-text mb-1">
        ...
        <!-- End Time -->
        <div>
          <label for="endTime" class="block text-sm font-medium text-text mb-1">
